...
HD_PWD='C:/Users/Wendy Li/Desktop/FPGA1/project/Reaction_Timer_assignment1/Reaction_Timer_assignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reactionTimer_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reactionTimer_TOP.tcl
